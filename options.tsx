...
import { DEFAULT_PROFILE, PROFILE_STORAGE_KEY } from "./src/constants/dictionary"
...
export default function OptionsIndex() {
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-[#09090b] font-sans antialiased">
      {/* Top Header Command Bar (Linear / Raycast Style) */}
        ...
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-sm tracking-tight text-zinc-900">AutoApply</span>
            </div>
            ...
            <span className="hidden sm:inline-block text-xs text-zinc-500">100% Local Storage</span>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
          {/* Navigation Sidebar (Linear Clean Tab Strip) */}
